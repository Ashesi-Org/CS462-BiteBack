    ...
    <div class="content">
        ...
        <div class="features">
            ...
            <div class="feature-card">
                ...
                <a href="find-a-mentor.php">Find a Mentor</a>
            </div>
            <div class="feature-card">
                <h2>Volunteer Opportunities</h2>
                <p>Engage with climate action initiatives by volunteering your time and skills for community-driven projects and events.</p>
                <a href="volunteer.php">Explore Opportunities</a>
            </div>
            <div class="feature-card">
            ...
            <ul>
                <?php while ($event = $events->fetch_assoc()): ?>
                    <li class="event-item">
                        ...
                        <em>Date: <?php echo $event['event_date']; ?></em>

                        <form method="POST">
                            <input type="hidden" name="join_event_id" value="<?php echo $event['event_id']; ?>">
